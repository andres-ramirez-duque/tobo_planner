...
def make_prp_runner(prp_root, solution_fn, deadend_detection, cmplan_abs_path, is_costed):
  deadend_str = ""
  ...
  s += prp_root + "/src/prp " + mode + "$1 $2 --dump-policy 2 --optimize-final-policy 1" + deadend_str + "\n\n"
